...
const u8 gText_SomeonesPC[] = _("SOMEONE'S VAULT");
const u8 gText_Challenges[] = _("CHALLENGES");
const u8 gText_LanettesPC[] = _("FI'S VAULT");
const u8 gText_PlayersPC[] = _("{PLAYER}'s SATCHEL");
const u8 gText_HallOfFame[] = _("HALL OF FAME");
const u8 gText_LogOff[] = _("STEP AWAY");
