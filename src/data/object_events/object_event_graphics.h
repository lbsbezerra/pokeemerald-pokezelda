...
const u32 gFieldEffectObjectPic_OrangeTallGrass[] = INCBIN_U32("graphics/field_effects/pics/orange_tall_grass.4bpp");
const u16 gFieldEffectObjectPalette_OrangeTallGrass[] = INCBIN_U16("graphics/field_effects/pics/orange_tall_grass.gbapal");
