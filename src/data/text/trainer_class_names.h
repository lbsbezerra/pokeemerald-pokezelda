const u8 gTrainerClassNames[][13] = {
    ...
    [TRAINER_CLASS_HIKER] = _("FIERY GORON"),
    [TRAINER_CLASS_TEAM_AQUA] = _("SOOGA CLAN"),
    ...
    [TRAINER_CLASS_TEAM_MAGMA] = _("YIGA CLAN"),
    [TRAINER_CLASS_EXPERT] = _("EXPERT"),
    [TRAINER_CLASS_AQUA_ADMIN] = _("AQUA ADMIN"),
    [TRAINER_CLASS_BLACK_BELT] = _("SUBROSIAN"),
    ...
    [TRAINER_CLASS_TUBER_F] = _("SMOLT ZORA"),
    [TRAINER_CLASS_TUBER_M] = _("SMOLT ZORA"),
    [TRAINER_CLASS_LADY] = _("HYLIAN NOBLE"),
    [TRAINER_CLASS_BEAUTY] = _("GERUDO VAI"),
    [TRAINER_CLASS_RICH_BOY] = _("BLING BLUPEE"),
